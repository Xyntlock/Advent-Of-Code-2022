...
let directoryToDelete = home

const spaceRequired = 30000000 - (70000000 - home.totalSize)

const getSmallestEnoughDirectory = (directory: Directory) => {
  if (directory.totalSize >= spaceRequired && directory.totalSize < directoryToDelete.totalSize) {
    directoryToDelete = directory
  }
  directory.subDirectories.forEach(dir => getSmallestEnoughDirectory(dir))
}

getSmallestEnoughDirectory(home)
